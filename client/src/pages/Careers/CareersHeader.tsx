        ...
        <div className="text-center mb-10 md:mb-12">
            ...
            >
                <span className="text-primary font-bold tracking-widest uppercase text-xs md:text-sm flex items-center gap-2">
                    <span className="material-symbols-rounded text-sm">groups</span> Careers
                </span>
            </motion.div>
            ...
            >
                <div className="flex flex-wrap justify-center items-center gap-x-3.5 md:gap-x-5">
                    ...
                    >
                        <img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=300&q=80" className="w-full h-full object-cover opacity-90" alt="Join the Mindtrix Media careers team" />
                    </motion.span>
                    <span className="text-secondary">With Us</span>
                </div>
                <div><span className='text-primary'>Build</span> the Future.</div>
            </motion.h1>
            ...
            >
                We&apos;re a Kolkata-based digital agency building websites, CRM, ERP &amp; SaaS products. Explore career opportunities with us.
            </motion.p>
        </div>
    );
};
